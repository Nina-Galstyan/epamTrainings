package pizzeriaPalmetto.storage;

import pizzeriaPalmetto.exception.NotFoundException;
import pizzeriaPalmetto.model.Ingredients;
import pizzeriaPalmetto.model.Order;
...
// Fill the Margarita pizza with the following ingredients: tomato paste, pepper, garlic, and bacon.
    ...
    public Pizza addPepperoniOro() throws NotFoundException {
        ...
        Pizza pizza = new Pizza();
        pizza.setName("PepperoniOro");
        pizza.setIngredients(ingredientsForPepperoniOro);
        pizza.setPizzaType(PizzaType.REGULAR);
        pizzaList.add(1, pizza);
    ...
    public Pizza addBasePZZ() throws NotFoundException {
        ...
        Pizza pizza = new Pizza();
        pizza.setName("Simple");
        pizza.setIngredients(ingredientsForBasePZZ);
        pizza.setPizzaType(PizzaType.REGULAR);
        pizzaList.add(2, pizza);
        Pizza peperoniOli = getByName("PeperoniOli");
        return peperoniOli;
    }
}